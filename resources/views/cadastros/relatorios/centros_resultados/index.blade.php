...
<div class="page-title">
    <div class="title_left">
        <h3>
            Centros de Resultados <small>Opções de Filtros.</small>
        </h3>
    </div>
...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="x_panel">
		    ...
		    <form id="conta-form" class="form-horizontal form-label-left mode2" target='_blank' method="POST" action="{{ url('cadastro/relatorio/centro_resultado') }}" novalidate>
