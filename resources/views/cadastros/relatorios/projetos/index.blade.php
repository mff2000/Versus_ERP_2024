...
<div class="page-title">
    <div class="title_left">
        <h3>
            Projetos <small>Opções de Filtros.</small>
        </h3>
    </div>
...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="x_panel">
		    ...
		    <form id="conta-form" class="form-horizontal form-label-left mode2" target='_blank' method="POST" action="{{ url('cadastro/relatorio/projeto') }}" novalidate>
            ...
            <div class="x_content">
                  ...
                  <div class="form-group">
                      ...
                      <label for="#" class="control-label col-md-3 col-sm-3 col-xs-12">Exibir:</label>
                      ...
                      <label for="#" class="control-label col-md-2 col-sm-2 col-xs-12">Ordenar Por:</label>
                      <div class="col-md-2 col-sm-2 col-xs-12">
