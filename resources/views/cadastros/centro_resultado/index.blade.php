...
<div class="page-title">
    ...
    <div class="title_right">
      ...
      <div class="pull-right">
        ...
        <a class="btn btn-sm btn-primary" href="{{ url('centroresultado/create') }}"><i class="fa fa-plus-square"></i> Incluir Registro</a>
                    ...
                    <tbody>
                        ...
                        @if (count($centros) > 0)
                            @foreach ($centros as $centro)
                                @if(!isset($centro->conta_superior))
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        ...
                                        <ul class="nav">
                                            <li>
                                                <a>{{ $centro->descricao }} <span class="fa fa-chevron-down"></span></a>
                                                
                                                @if (count($centro->children) > 0)
                                                <ul class="nav child_menu" style="display: none">

                                                    <?php 
                                                        $childrens = $centro->children;
                                                        $ids = array();
                                                    ?>
                                                    ...
                                                    @while( $child )
                                                        ...
                                                        @if($child->deleted_at == null)
                                                            ...
                                                            <span>
                                                                ...
                                                                <a href="{{ url('centroresultado').'/'.$child->id.'/create' }}"><i class="fa fa-plus"></i></a>
                                                                <a href="{{ url('centroresultado').'/'.$child->id.'/edit' }}"><i class="fa fa-pencil"></i></a>
                                                                
                                                                <form action="{{ url('centroresultado').'/' .$child->id }}" method="POST">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('DELETE') }}
                                    ...
                                    <td class=" last" style="width:190px">
                                       <ul>                                            
                                            <li style="float:left;">
                                                <button onclick="window.location='{{ url('centroresultado').'/'.$centro->id.'/create' }}'" data-placement="top" data-toggle="tooltip" type="button" data-original-title="Adicionar" class="btn  btn-sm tooltips" style="margin-bottom:0;"><i class="fa fa-plus"></i> </button>
                                            </li>
                                            {!! linksDefault('centroresultado', $centro->id) !!}
                                        </ul>
                                    </td>
                                </tr>
                                @endif
