...
<div class="page-title">
    ...
    <div class="title_right">
      ...
      <div class="pull-right">
        ...
        <a class="btn btn-sm btn-primary" href="{{ url('contacontabel/create') }}"><i class="fa fa-plus-square"></i> Incluir Registro</a>
        ...
        <div class="x_panel">
            ...
            <div class="x_content" id="centro-menu">
                            ...
                            @foreach ($contas as $conta)
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        ...
                                        <ul class="nav">
                                            <li>
                                                <a>{{ $conta->descricao }} <span class="fa fa-chevron-down"></span></a>
                                                    ...
                                                    @while( $child )
                                                        ...
                                                        @if($child->deleted_at == null)
                                                            ...
                                                            <span>
                                                                ...
                                                                <a href="{{ url('contacontabel').'/'.$child->id.'/create' }}"><i class="fa fa-plus"></i></a>
                                                                <a href="{{ url('contacontabel').'/'.$child->id.'/edit' }}"><i class="fa fa-pencil"></i></a>
                                                                
                                                                <form action="{{ url('contacontabel').'/' .$child->id }}" method="POST">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('DELETE') }}
                                    ...
                                    <td class=" last" style="width:190px">
                                       <ul>                                            
                                            <li style="float:left;">
                                                <button onclick="window.location='{{ url('contacontabel').'/'.$conta->id.'/create' }}'" data-placement="top" data-toggle="tooltip" type="button" data-original-title="Adicionar" class="btn  btn-sm tooltips" style="margin-bottom:0;"><i class="fa fa-plus"></i> </button>
                                            </li>
                                            {!! linksDefault('contacontabel', $conta->id) !!}
                                        </ul>
                                    </td>
                                </tr>
                                @endif
                ...
                <div class="btn-toolbar right">
                    ...
                    <div class="col-md-4">
                        <p> Total de <code>{!! $contas->total() !!}</code> registros</p>
                    </div>
                    <div class="col-md-8">
                        <span class='right'>
                            {!! $contas->links() !!}
