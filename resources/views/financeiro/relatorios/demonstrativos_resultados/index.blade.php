...
<div class="page-title">
    <div class="title_left">
        <h3>
            Demonstrativo de Resultado <small>Opções de Filtros.</small>
        </h3>
    </div>
...
<div class="row">
    ...
    @include('flash::message')
		...
		<div class="x_panel">
		    ...
		    <form id="conta-form" class="form-horizontal form-label-left mode2" target='_blank' method="POST" action="{{ url('financeiro/relatorio/demonstrativo_resultado') }}" novalidate>
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12">
                          <ul class="nav navbar-left panel_toolbox">
                            <li>
                              ...
                              <span class="label label-success" style="color:#fff">Recebimento</span>
                            </li>
                            <li>
                              <input type="checkbox" class="flat" name="filtros[tipo_recebimento]" value="RCT" checked="checked">
                              <span class="label label-warning" style="color:#fff">Pagamento</span>
                            </li>
                            <li>
                              <input type="checkbox" class="flat" name="filtros[orcado]" value="ORC">
                              <span class="label label-info" style="color:#fff">Orçado x Realizado</span>
                            </li>
                          </ul>
                      </div>
