...
<div class="page-title">
	...
	<div class="title_right">
	  ...
	  <div class="pull-right">
	  	...
	  	<a class="btn btn-sm btn-primary" href="{{ url('pedido/create') }}"><i class="fa fa-plus-square"></i> Incluir Registro</a>
			...
			<tbody>
			  ...
			  @if (count($pedidos) > 0)
			      ...
			      <tr class="even pointer" >
			        ...
			        <td class=" ">{{ $pedido->favorecido->nome_empresarial }} </td>
			        <td class=" ">{{ $pedido->pedido_favorecido }}</td>			        
			        <td class=" ">{{ $pedido->vendedor1->id .'-'. $pedido->vendedor1->nome_empresarial }} </td>
			        ...
			        <td class=" last">
			        	<ul>
			        		{!! linksDefault('pedido', $pedido->id, true, true) !!}
			        	</ul>
			        </td>
			      </tr>
			  	 @endforeach
