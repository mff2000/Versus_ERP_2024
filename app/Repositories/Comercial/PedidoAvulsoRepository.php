...
class PedidoAvulsoRepository extends RepositoryAbstract implements RepositoryInterface 
{
    ...
    public function paginate($page = 1, $limit = 50, $all = false, $where = null)
    {
        ...
        $query = \App\Model\Comercial\Pedido::where('favorecido_id', '!=', NULL)->orderBy('id', 'DESC');
        $query = getWhere($query, $where);
